<template>
  ...
  >
    <div class="card">
      <div class="card-header bg-dark text-white font-weight-bolder px-4 py-4">
      ...
      <div class="card-body px-4 py-4">
        <div class="row">
          <div class="col-12">
            ...
            >
              <label class="font-weight-bolder mb-0 mr-4">
                Section name
              </label>
              <input
              ...
              <span class="switch switch-primary switch-outline">
                <label>
                  <input
                    type="checkbox"
                    name="select"
                    v-model="configuration.section_card_configuration.subtitle"
                  />
                  <span></span>
                </label>
              </span>
