<template>
  <span :class="`svg-icon svg-icon-${color} svg-icon-${size}x`">
    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-02-01-052524/theme/html/demo1/dist/../src/media/svg/icons/Design/Component.svg-->
    <svg
...
export default class IconComponent extends Vue {
  ...
  @Prop({ default: '2' }) readonly size!: number;
}
</script>
